...
gas = st.number_input(input('油量的資料收集:油箱滿是10格 =>'))
speed= st.number_input(input('車速的資料收集:限速100 =>'))
temp = st.number_input(input('溫度的資料收集:限溫30 =>'))
轉速=st.number_input(input('轉速資料的收集:限轉12000 =>'))
